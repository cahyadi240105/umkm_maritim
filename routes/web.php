...
// Route::post('kuliner/kirim-wa', [KulinerController::class, 'kirim'])->name('kuliner.kirim');
// Route::get('kuliner/kirim-wa', function () {
//     return redirect()->route('kuliner.index')->with('error', 'Akses tidak valid. Gunakan form untuk mengirim pesan.');
// });

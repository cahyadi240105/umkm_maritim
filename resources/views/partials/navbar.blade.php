    ...
    <div class=" flex flex-wrap items-center justify-between mx-10 py-5">
      ...
      <div class="hidden w-full md:block md:w-auto text-xl" id="navbar-default">
        <ul class="flex flex-col md:flex-row items-start md:items-center space-y-2 md:space-y-0 md:space-x-6 mt-4 md:mt-0 text-white font-medium text-sm px-4 md:px-0">
          ...
          <li>
            <a href="/galeri" class="{{ ($title === 'Galeri') ? 'font-bold' : 'font-medium' }} hover:text-yellow-400">Galeri</a>
          </li>
          <li>
            <a href="/tentangkami" class="{{ ($title === 'Tentang Kami') ? 'font-bold' : 'font-medium' }} hover:text-yellow-400">Tentang Kami</a>
          </li>
          <li>
            <a href="/kontak" class="{{ ($title === 'Kontak Kami') ? 'font-bold' : 'font-medium' }} hover:text-yellow-400">Kontak</a>
          </li>
        </ul>
      </div>
    </div>

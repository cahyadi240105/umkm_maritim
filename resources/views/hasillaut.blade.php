@include('partials.navbar')
    <div class="container mx-auto px-4 font-[Open Sans]">
        ...
        {{-- Content --}}
        <div class="max-w-screen-xl mx-auto px-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 mt-6">
            ...
            <div class="relative max-w-[300px] w-full h-[240px] bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden">
                    ...
                    <div class="relative p-4 w-full max-w-2xl max-h-full">
                        <div class="relative bg-white rounded-lg shadow-sm">
                            ...
                            <div class="p-4 md:p-5 font-[Open Sans] text-justify space-y-4">
                                <p class="text-base leading-relaxed text-black font-bold">{{ $hasil['judul'] }}</p>
                                <p class="text-black text-[clamp(0.9rem,1.5vw,1rem)]">{{ $hasil['deskripsi'] }}</p>
                ...
                <div class="p-4">
                    <a href="#">
                        <h5 class="text-base tracking-tight text-black">{{ $hasil['judul'] }}</h5>
                    </a>
                    <p class="text-sm text-black mt-1 font-bold">Rp.{{ number_format($hasil['harga'], 0, ',', '.') }}</p>
                    <p class="text-sm text-black mt-1">
                        <i class="fa-solid fa-location-dot"></i> {{ $hasil['lokasi'] }}
                    </p>
                </div>
            
                <!-- WhatsApp -->
                <a href="{{ route('wa.hasillaut', ['id' => $hasil['id']]) }}"
